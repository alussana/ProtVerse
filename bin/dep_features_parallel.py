...
def main():
    ...
    dependency = pd.read_csv(
        dependency_table_file, sep='\t', index_col=0, header=None
    )
    ...
    df_cols = [
        ...
        'DepMap CCC',
        r'DepMap $\cos^2\theta$',
        r'DepMap $\mathrm{sign}\,(\cos\theta)$',
        r'DepMap $r^2$',
        r'DepMap $\mathrm{sign}\,(r)$',
        r'DepMap $r^2$ Sig.',
        r'DepMap $r_s^2$',
        r'DepMap $\mathrm{sign}\,(r_s)$',
        r'DepMap $r_s^2$ Sig.',
        'DepMap Max CR',
        'DepMap Min CR',
        'DepMap Tot CR',
    ...
    arg1 = [dependency for i in range(len(gene_pairs_dfs))]
    arg2 = gene_pairs_dfs
