...
def main():
    ...
    for i in range(len(gene_pairs)):
        ...
        gene_1_expr = eprot.loc[eprot.index == gene_1, ].transpose()
        gene_2_expr = eprot.loc[eprot.index == gene_2, ].transpose()
    ...
    gene_pairs['PRIDE (tissues) Linfoot MI'] = norm_mutual_info
    gene_pairs['PRIDE (tissues) CCC'] = ccc_coef
    gene_pairs[r'PRIDE (tissues) $\cos^2\theta$'] = cos_sim
    gene_pairs[r'PRIDE (tissues) $\mathrm{sign}\,(\cos\theta)$'] = cos_sign
    gene_pairs[r'PRIDE (tissues) $r^2$'] = pearson
    gene_pairs[r'PRIDE (tissues) $\mathrm{sign}\,(r)$'] = pearson_sign
    gene_pairs[r'PRIDE (tissues) $r^2$ Sig.'] = pearson_pval
    gene_pairs[r'PRIDE (tissues) $r_s^2$'] = spearman
    gene_pairs[r'PRIDE (tissues) $\mathrm{sign}\,(r_s)$'] = spearman_sign
    gene_pairs[r'PRIDE (tissues) $r_s^2$ Sig.'] = spearman_pval
    gene_pairs['PRIDE (tissues) Max CR'] = max_codetection
    gene_pairs['PRIDE (tissues) Min CR'] = min_codetection
    gene_pairs['PRIDE (tissues) Tot CR'] = tot_codetection
    gene_pairs['PRIDE (tissues) Data'] = data_flag
    gene_pairs['PRIDE (tissues) Overlap'] = overlap_flag
