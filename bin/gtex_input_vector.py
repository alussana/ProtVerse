...
def main():
    ...
    for i in range(len(gene_pairs)):
        ...
        gene_1_expr = gtex.loc[gtex.index == gene_1, ].transpose()
        gene_2_expr = gtex.loc[gtex.index == gene_2, ].transpose()
    ...
    gene_pairs['GTEx Linfoot MI'] = norm_mutual_info
    gene_pairs['GTEx CCC'] = ccc_coef
    gene_pairs[r'GTEx $\cos^2\theta$'] = cos_sim
    gene_pairs[r'GTEx $\mathrm{sign}\,(\cos\theta)$'] = cos_sign
    gene_pairs[r'GTEx $r^2$'] = pearson
    gene_pairs[r'GTEx $\mathrm{sign}\,(r)$'] = pearson_sign
    gene_pairs[r'GTEx $r^2$ Sig.'] = pearson_pval
    gene_pairs[r'GTEx $r_s^2$'] = spearman
    gene_pairs[r'GTEx $\mathrm{sign}\,(r_s)$'] = spearman_sign
    gene_pairs[r'GTEx $r_s^2$ Sig.'] = spearman_pval
    gene_pairs['GTEx Max CR'] = max_codetection
    gene_pairs['GTEx Min CR'] = min_codetection
    gene_pairs['GTEx Tot CR'] = tot_codetection
    gene_pairs['GTEx Data'] = data_flag
    gene_pairs['GTEx Overlap'] = overlap_flag
