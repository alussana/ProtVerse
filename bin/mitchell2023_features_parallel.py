...
def main():
    ...
    mitchell2023 = pd.read_csv(
        mitchell2023_table_file, sep='\t', index_col=0, header=None
    )

    df_cols = [
        'gene_1',
        'gene_2',
        'PRIDE (perturb.) Linfoot MI',
        'PRIDE (perturb.) CCC',
        r'PRIDE (perturb.) $\cos^2\theta$',
        r'PRIDE (perturb.) $\mathrm{sign}\,(\cos\theta)$',
        r'PRIDE (perturb.) $r^2$',
        r'PRIDE (perturb.) $\mathrm{sign}\,(r)$',
        r'PRIDE (perturb.) $r^2$ Sig.',
        r'PRIDE (perturb.) $r_s^2$',
        r'PRIDE (perturb.) $\mathrm{sign}\,(r_s)$',
        r'PRIDE (perturb.) $r_s^2$ Sig.',
        'PRIDE (perturb.) Max CR',
        'PRIDE (perturb.) Min CR',
        'PRIDE (perturb.) Tot CR',
        #'PRIDE (perturb.) Data',
        #'PRIDE (perturb.) Overlap'
    ]

    gene_pairs_dfs = [gene_pairs.iloc[i,] for i in range(len(gene_pairs))]

    arg1 = [mitchell2023 for i in range(len(gene_pairs_dfs))]
    arg2 = gene_pairs_dfs
