...
def main():
    ...
    proteomehd_table_file = sys.argv[2]
    n_proc = int(sys.argv[3])

    gene_pairs = pd.read_csv(gene_pairs_file, sep='\t', header=None)
    gene_pairs.columns = ['gene_1', 'gene_2']

    proteomehd = pd.read_csv(
        proteomehd_table_file, sep='\t', index_col=0, header=None
    )

    df_cols = [
        'gene_1',
        'gene_2',
        'ProteomeHD Linfoot MI',
        'ProteomeHD CCC',
        r'ProteomeHD $\cos^2\theta$',
        r'ProteomeHD $\mathrm{sign}\,(\cos\theta)$',
        r'ProteomeHD $r^2$',
        r'ProteomeHD $\mathrm{sign}\,(r)$',
        r'ProteomeHD $r^2$ Sig.',
        r'ProteomeHD $r_s^2$',
        r'ProteomeHD $\mathrm{sign}\,(r_s)$',
        r'ProteomeHD $r_s^2$ Sig.',
        'ProteomeHD Max CR',
        'ProteomeHD Min CR',
        'ProteomeHD Tot CR',
        #'ProteomeHD Data',
    ...
    arg1 = [proteomehd for i in range(len(gene_pairs_dfs))]
    arg2 = gene_pairs_dfs
